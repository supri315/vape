            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                 ...
                 <!--    <li>
                     ...
                     <li>
                        <a href="<?php echo base_url("manager/barang"); ?>"> <i class="menu-icon ti-email"></i>Barang </a>
                    </li> 
                   <!--  <li>
                    ...
                    <li>
                         <a href="<?php echo base_url("manager/laporan_pembelian"); ?>"> <i class="menu-icon ti-email"></i>Laporan Pembelian </a>
                    </li>
                     <li>
                         <a href="<?php echo base_url("manager/laporan_penjualan"); ?>"> <i class="menu-icon ti-email"></i>Laporan Penjualan </a>
                    </li>
                <!--     <li>
