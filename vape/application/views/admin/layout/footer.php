...
<!--   <script type="text/javascript">
          var getstok = $('#stok').val();
      var getjumlah = $('#jumlah').val();
      if (jumlah > stok) {
        alert ('harus sesuai ya bos');
      }
  </script> -->
...
$(document).ready(function(){
    ...
    var tgl = new Date();
      ...
      var month = (tgl.getMonth() < 9 ? '0': '') + (tgl.getMonth()+1);
      var year = tgl.getFullYear();
      var jumlah = year+"-"+month+"-"+date;
      if ( x > jumlah) {
       alert("Maksimal Tanggal Hari ini !");
         $(this).val(jumlah);
      }
